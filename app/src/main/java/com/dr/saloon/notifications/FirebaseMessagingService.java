...
import static com.dr.saloon.utils.AppConstaints.INTENT_TYPE;
import static com.dr.saloon.utils.AppConstaints.INTENT_TYPE_NOTIFICATION;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
   ...
   // SharedPref.setData(getApplicationContext(),"Massage","Pending");
        ...
        resultIntent.putExtra(INTENT_TYPE, INTENT_TYPE_NOTIFICATION);
        resultIntent.setAction(INTENT_TYPE_NOTIFICATION);
